...
let getHomePage = async (req, res) => {
  ...
  try {
    let data = await db.User.findAll(); //lay du liệu tu models/index
    // console.log("........................");
    // console.log(data);
    // console.log("........................");
...
let putCRUD = async (req, res) => {
  ...
  //let data1 = await CRUDService.getAllUser();//hiển thị danh sach user
  return res.render("users/findAllUser.ejs", {
    datalist: data1,
  });
  // return res.send('update thanh công');
};
